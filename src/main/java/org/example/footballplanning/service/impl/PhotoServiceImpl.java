...
public class PhotoServiceImpl implements PhotoService {
    ...
    public UploadPhotoResponseBean uploadPhoto(MultipartFile file) {
        ...
        if (user.getPhoto() != null) {
            ...
            if (oldPhoto.exists() && !oldPhoto.delete()) {
                throw new RuntimeException("Failed to delete old photo: " + oldPhoto.getPath());
            }
        }
    ...
    public DeletePhotoResponseBean deletePhoto() {
        ...
        if (file.exists() && !file.delete()) {
            throw new RuntimeException("Failed to delete old photo: " + file.getPath());
        }
    ...
    public ResponseEntity<byte[]> showProfilePhoto() {
        ...
        try (FileInputStream fileOutputStream = new FileInputStream(file)) {
            byteFile = fileOutputStream.readAllBytes();
        }
